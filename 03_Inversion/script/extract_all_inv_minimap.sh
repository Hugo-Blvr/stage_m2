...
# ============================================================================
# Description:     Ce script automatise la détection complète des inversions génomiques
#                  entre multiples séquences au format FASTA. Il effectue une analyse
#                  exhaustive par paires de tous les fichiers FASTA dans le dossier
#                  spécifié, en traitant indépendamment chaque chromosome commun.
#
#                  Le processus d'analyse suit les étapes suivantes:
#                  1. Extraction des chromosomes communs entre chaque paire de fichiers
#                  2. Pour chaque chromosome:
#                     a. Alignement des séquences avec minimap2
#                     b. Filtrage des alignements selon le seuil d'identité spécifié
#                     c. Détection des inversions avec SyRI
#                     d. Extraction et formatage des résultats
#                  3. Compilation de toutes les inversions détectées dans un fichier TSV
# ============================================================================
